...
@click.option('--min-delta', show_default=True, default=None, help='Minimum improvement between epochs to reset early stopping. Default is scales the delta by the best loss')
